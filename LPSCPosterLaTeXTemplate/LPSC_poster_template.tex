...
\begin{textblock}{4.2}(19,12.2)
  ...
  Or you might want to make the figures line up at the bottom.
  This would be more difficult because the textblocks are defined by their top, left corner.
